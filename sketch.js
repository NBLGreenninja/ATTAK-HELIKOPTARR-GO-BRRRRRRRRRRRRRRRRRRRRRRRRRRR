...
function preload()
{
	backgroundIMG=loadImage("green lines.jpg")
...
function setup() {
	...
	background=createSprite(400,350,800,700);
	...
	groundSprite.shapeColor=color(86,242,109)
	...
	bucketBottom.shapeColor =color(86,242,109);
	bucketLeft.shapeColor =color(86,242,109);
	bucketRight.shapeColor =color(86,242,109);
